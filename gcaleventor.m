function result=gcaleventor(userName, password, ...
    title, content, location, smsMe, emailMe, DelayInMin)
% result=gcaleventor(userName, password, title, content, location, smsMe, emailMe, DelayInMin)
% author: Ofir Bibi
